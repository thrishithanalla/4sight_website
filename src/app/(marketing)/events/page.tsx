        ...
        <Wrapper className="py-12 md:py-20 relative overflow-hidden">
            <Container>
                ...
                <div className="flex flex-col items-center justify-center text-center max-w-3xl mx-auto mb-10 md:mb-16 px-4">
                    <h1 className="text-3xl md:text-5xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-orange-500 to-amber-400 mb-4 md:mb-6">
                        Events & Webinars
                    </h1>
                ...
                <div className="flex flex-col gap-12 md:gap-20 max-w-7xl mx-auto w-full">
                    ...
                    <div className="group relative overflow-hidden rounded-2xl border border-white/10 bg-white/5 p-5 md:p-10 hover:border-orange-500/50 hover:bg-white/8 transition-all">
                        <div className="flex flex-col gap-6 md:gap-8">
                            <div className="flex flex-col lg:flex-row gap-8 items-start">

                                <div className="flex-1 w-full space-y-6">
                                    <div className="space-y-4">
                                        <h3 className="text-2xl sm:text-3xl md:text-5xl font-bold text-orange-500">
                                            AI4AndhraPolice <span className="text-orange-500/80">Hackathon</span>
                                        </h3>
                                        <div className="flex flex-wrap gap-3 md:gap-4 text-sm text-black">
                                            <div className="flex items-center gap-2 bg-white/10 px-3 py-1.5 rounded-full border border-white/10">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="text-orange-500"><rect width="18" height="18" x="3" y="4" rx="2" ry="2" /><line x1="16" x2="16" y1="2" y2="6" /><line x1="8" x2="8" y1="2" y2="6" /><line x1="3" x2="21" y1="10" y2="10" /></svg>
                                                <span className="font-medium text-gray-800 dark:text-gray-200">June 27 – 29, 2025</span>
                                            </div>
                                            <div className="flex items-center gap-2 bg-white/10 px-3 py-1.5 rounded-full border border-white/10">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="text-orange-500"><path d="M20 10c0 6-8 12-8 12s-8-6-8-12a8 8 0 0 1 16 0Z" /><circle cx="12" cy="10" r="3" /></svg>
                                                <span className="font-medium text-gray-800 dark:text-gray-200">R.V.R. & J.C. College, Guntur</span>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div className="flex flex-col gap-6">
                                        <div className="space-y-3">
                                            <h4 className="text-lg md:text-xl font-semibold text-orange-500">Event Overview</h4>
                                        ...
                                        <div>
                                            <Link
                                                ...
                                                target="_blank"
                                                className="inline-flex items-center justify-center gap-2 bg-orange-500 text-white px-6 py-3 rounded-lg hover:bg-orange-600 transition-colors font-medium text-base w-full md:w-auto"
                                            >
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12 items-center">
                        ...
                        <div className="order-1 md:order-2 space-y-6">
                            ...
                            <h2 className="text-2xl md:text-3xl font-bold text-orange-500">Why This Matters</h2>
                            <p className="text-gray-700 dark:text-gray-300 font-medium leading-relaxed">The primary objective of the hackathon is to bridge the gap between law enforcement needs and cutting-edge AI capabilities.</p>
                    ...
                    <div className="space-y-8 md:space-y-10">
                        <div className="text-center max-w-3xl mx-auto space-y-3 md:space-y-4">
                            <h2 className="text-2xl md:text-4xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-orange-500 via-orange-500 to-orange-500">
                                Key Focus Areas
                            </h2>
                    ...
                    <div className="bg-gradient-to-r from-orange-500/10 to-transparent border border-orange-500/20 rounded-2xl p-6 md:p-12 text-center space-y-4 md:space-y-6">
